...
public class GraphMatching {
	 ...
	 * @throws Exception
	 */
	public GraphMatching(String prop, String dbFile, String qryFile) throws Exception {
		// initialize the matching
		//System.out.println("Init from properties...");
                String rstFile="tmp";
		this.init(prop, dbFile, qryFile, rstFile);
	 ...
	 * @throws Exception
	 */
	private void init(String prop, String dbFile, String qryFile, String rstFile) throws Exception {
		// load the properties file
		Properties properties = new Properties();
		properties.load(new FileInputStream(prop));

		// define result folder
		String resultFile = rstFile; //properties.getProperty("result");
...
//			e.printStackTrace();
	...
	//		e.printStackTrace();
		...
		String sourceString = dbFile;
		String targetString = qryFile;
